...
- (void)layoutWithModel:(id)model{
    _avatorImageView.image = [UIImage imageNamed:@"icon_pickup"];
    _nickLabel.text = @"极客时间";
    
    _commentImageView.image = [UIImage imageNamed:@"icon_pickup"];
    _commentLabel.text = @"100";
    
    _likeImageView.image = [UIImage imageNamed:@"icon_pickup"];
    _likeLabel.text = @"25";

    _shareImageView.image = [UIImage imageNamed:@"icon_pickup"];
    _shareLabel.text = @"分享";
